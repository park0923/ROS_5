...
"""autogenerated by genpy from deu_ros/RotationActionResult.msg. Do not edit."""
import codecs
import sys
...
class RotationActionResult(genpy.Message):
  _md5sum = "674248050dd792228e686107f2fb59cd"
  _type = "deu_ros/RotationActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','deu_ros/RotationResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RotationActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = deu_ros.msg.RotationResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = deu_ros.msg.RotationResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.result.final_orientation
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.final_orientation,) = _get_struct_f().unpack(str[start:end])
      return self
