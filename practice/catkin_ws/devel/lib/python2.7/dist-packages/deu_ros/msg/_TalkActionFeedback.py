...
"""autogenerated by genpy from deu_ros/TalkActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class TalkActionFeedback(genpy.Message):
  ...
  _type = "deu_ros/TalkActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','deu_ros/TalkFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = deu_ros.msg.TalkFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = deu_ros.msg.TalkFeedback()
