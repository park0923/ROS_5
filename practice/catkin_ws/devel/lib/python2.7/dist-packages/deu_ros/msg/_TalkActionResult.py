...
"""autogenerated by genpy from deu_ros/TalkActionResult.msg. Do not edit."""
import codecs
import sys
...
class TalkActionResult(genpy.Message):
  ...
  _type = "deu_ros/TalkActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','deu_ros/TalkResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = deu_ros.msg.TalkResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = deu_ros.msg.TalkResult()
